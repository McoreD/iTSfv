...
AppName=iTSfv
AppVerName=iTSfv 5.54.1.5
VersionInfoVersion=5.54.1.5
VersionInfoTextVersion=5.54.1.5
...
[Files]
Source: "iTSfv\Docs\iTSfv-manual.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{app}\iTSfv-manual.pdf"; Description: "{cm:LaunchProgram,iTSfv Manual}"; Flags: nowait unchecked postinstall shellexec skipifsilent
